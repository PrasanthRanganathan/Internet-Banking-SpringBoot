...
<body>
    ...
    <section>
        ...
        <h1>Card Manager</h1><br>

        <a class="a1" href="blockCard">Block Card</a><br><br>
        
        <a class="a1" href="changePin">Change Pin</a><br><br>
        <a class="a1" href="setLimit">Set withdrawal limit</a>
