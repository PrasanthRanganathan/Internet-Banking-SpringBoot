    ...
    <section>
            <h1>Apply Loan</h1>
                <div style="height: 170px;">
                    <a href="applyLoan" class="a1">Personal Loan</a><br><br>
                    <a href="applyLoan" class="a1">Two Weeler Loan</a><br><br>
                    <a href="applyLoan" class="a1">Car Loan</a><br><br>
                    <a href="applyLoan" class="a1">Education Loan</a><br><br>
                    <a href="applyLoan" class="a1">House Loan</a><br><br>
                </div>
            <h1>View Status</h1>
                <div>
                    <a href="loanStatus" class="a1">Check Loan Status</a><br><br>
                </div>
    </section>
